        ...
        if (token != null) {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    errorMessage = "You don't have any sites in your favorites."
                }
            } catch (e: Exception) {
                ...
                when {
                    token == null -> {
                        ...
                        Column(
                            ...
                            Text("You are not logged in.", style = MaterialTheme.typography.headlineSmall)
                    ...
                    savedObjectives.isEmpty() -> {
                        Text(
                            "You don't have any sites in your favorites.",
                            ...
                            items(savedObjectives, key = { it.idObiectiv }) { obiectiv ->
                                ...
                                LaunchedEffect(dismissState.currentValue) {
                                    if (dismissState.currentValue == DismissValue.DismissedToEnd) {
                                        // Swipe to "mark visited" - DOAR toast, nu stergem
                                ...
                                SwipeToDismiss(
                                    ...
                                    dismissContent = {
                                        Card(
                                            modifier = Modifier
                                                .fillMaxWidth()
                                                .clickable { onObiectivClick(obiectiv) }, //navigare la mapare
